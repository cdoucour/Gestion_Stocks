...
public class Formulaire extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       //TODO Rajouter Ici le code permettant de le mettre dans la bonne catégorie.
       //Le nom de la catégorie sélectionnée est dans la vairable Categorie.
       //
      DefaultMutableTreeNode category = null;
        

        category = new DefaultMutableTreeNode("Categorie 3");
        top.add(category);
